const QA_BANK = {
  // ── 1. ELIGIBILITY CHECK ──
  'eligibility': '##section## ✅ Required Steps\n• Make sure you are a Indian citizen\n• Be at least 18 years old by Election Day\n• Live in the State/UT where you want to vote\n\n##section## ⚠️ Important Notes\n• Every State/UT has different rules. Check vote.gov to be sure.',

  // ── 2. VOTER REGISTRATION ──
  'register': '##section## ✅ Required Steps\n• Go to vote.gov to find your State/UT\'s sign-up page\n• Sign up online, by mail, or in person\n\n##section## ⚠️ Important Notes\n• Don\'t wait too long! Each State/UT has a different due date.',

  // ── 3. VERIFICATION ──
  'verify': '##section## ✅ Required Steps\n• Go to your State/UT\'s official election website\n• Look up your name to make sure you are signed up\n• Check that your address is right\n\n##section## ⚠️ Important Notes\n• Only use official government websites to check.',

  // ── 4. POLLING BOOTH IDENTIFICATION ──
  'polling': '##section## ✅ Required Steps\n• Use your State/UT\'s website to find your voting spot\n• Check what time they open and close\n\n##section## ⚠️ Important Notes\n• You must go to the correct location for your home address.',

  // ── 5. VOTING PROCESS ──
  'id': '##section## ✅ Required Steps\n• Check your State/UT\'s website to see if you need an ID to vote\n• Bring your ID with you on Election Day\n\n##section## ⚠️ Important Notes\n• Some State/UTs do not ask for a photo ID.',

  'mail': '##section## ✅ Required Steps\n• Ask your local election office for a mail-in EVM (Electronic Voting Machine)\n• Fill it out carefully and sign the envelope\n• Send it back before the due date\n\n##section## ⚠️ Important Notes\n• Not everyone can vote by mail. Check your State/UT\'s rules.',

  'early': '##section## ✅ Required Steps\n• Find out if your State/UT lets you vote before Election Day\n• Go to an official early voting spot\n\n##section## ⚠️ Important Notes\n• Not all State/UTs allow you to vote early.',

  'provisional': '##section## ✅ Required Steps\n• Ask the poll worker for a "provisional EVM (Electronic Voting Machine)" if there is a problem finding your name\n• Ask for a receipt so you can track it\n\n##section## ⚠️ Important Notes\n• You always have the right to ask for this special EVM (Electronic Voting Machine).',

  // ── 6. RESULT AWARENESS ──
  'results': '##section## ✅ Required Steps\n• Check your State/UT\'s official website to see who won\n\n##section## ⚠️ Important Notes\n• News on TV or social media is not the final official answer.',
...
const tests = [
  ...
  { id: "2. Rural user", msg: "I live out in the country, how do I get a mail-in EVM (Electronic Voting Machine)?" },
